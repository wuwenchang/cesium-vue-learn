    ...
    addCircleGeometry (viewer) {
      ...
      let boxInstance = new Cesium.GeometryInstance({
        ...
        modelMatrix: Cesium.Matrix4.multiplyByTranslation(Cesium.Transforms.eastNorthUpToFixedFrame(
          Cesium.Cartesian3.fromDegrees(-85.59777, 20.03883)), new Cesium.Cartesian3(0.0, 0.0, 1000.0), new Cesium.Matrix4()),
        attributes: {
