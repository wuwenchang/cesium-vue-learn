...
export default {
  ...
  mounted () {
    ...
    this.addEllipseOutlineGeometry(viewer)
  },
  methods: {
    initCesium: function () {
    ...
    addEllipseOutlineGeometry (viewer) {
      // Create an ellipse.
      let ellipse1 = new Cesium.EllipseOutlineGeometry({
        center: Cesium.Cartesian3.fromDegrees(-75.59777, 40.03883),
        semiMajorAxis: 500000.0,
        semiMinorAxis: 300000.0,
        rotation: Cesium.Math.toRadians(60.0)
      })
      let geometry1 = Cesium.EllipseOutlineGeometry.createGeometry(ellipse1)
      ...
      let ellipse2 = new Cesium.EllipseOutlineGeometry({
        center: Cesium.Cartesian3.fromDegrees(-85.59777, 40.03883),
        semiMajorAxis: 500000.0,
        semiMinorAxis: 500000.0,
        rotation: Cesium.Math.toRadians(60.0)
      })
      let geometry2 = Cesium.EllipseOutlineGeometry.createGeometry(ellipse2)
