...
export default {
  ...
  mounted () {
    ...
    this.addColorMaterialProperty(viewer)
  },
  methods: {
    initCesium: function () {
    ...
    addColorMaterialProperty (viewer) {
      // 创建一个动态变化的盒子
      ...
      var sampledProperty = new Cesium.SampledProperty(Cesium.Color)
      ...
      sampledProperty.addSample(Cesium.JulianDate.fromIso8601('2019-01-03T00:00:00.00Z'),
        Cesium.Color.BLUE)
      ...
      let entity = viewer.entities.add({
        ...
        box: {
          ...
          material: new Cesium.ColorMaterialProperty(sampledProperty), // 材质
          fill: true, // 是否填充
