...
export default {
  ...
  mounted () {
    ...
    this.addSampledProperty(viewer)
  },
  methods: {
    initCesium: function () {
    ...
    addSampledProperty (viewer) {
      ...
      property.addSample(Cesium.JulianDate.fromIso8601('2019-01-02T00:00:00.00Z'),
        new Cesium.Cartesian3(600000.0, 400000.0, 700000.0))
