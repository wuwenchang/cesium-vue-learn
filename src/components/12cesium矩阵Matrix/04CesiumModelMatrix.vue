...
export default {
  ...
  methods: {
    ...
    add3DTileset (viewer) {
      ...
      const mat3RotateX = Cesium.Matrix3.fromRotationX(Cesium.Math.toRadians(45))
      const translation = Cesium.Cartesian3.fromArray([1000000, 1000000, 1000000])
      var scaleMat4 = Cesium.Matrix4.fromScale(new Cesium.Cartesian3(1.0, 2.0, 3.0))
      // 旋转平移矩阵
      const mat4 = Cesium.Matrix4.fromRotationTranslation(mat3RotateX, translation)

      let modelMatrix = boxInstance1.modelMatrix
      let matrix4 = new Cesium.Matrix4()
      Cesium.Matrix4.multiply(modelMatrix, mat4, matrix4)
      Cesium.Matrix4.multiply(matrix4, scaleMat4, matrix4)
