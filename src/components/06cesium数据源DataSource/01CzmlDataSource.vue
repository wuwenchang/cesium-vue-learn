...
export default {
  ...
  methods: {
    ...
    addCzmlDataSource (viewer) {
      /* viewer.dataSources.add(
        Cesium.CzmlDataSource.load('http://localhost:8888/Apps/SampleData/simple.czml')
      );

      viewer.camera.flyHome(0); */

      let czmlDataSourcePromise = Cesium.CzmlDataSource.load('http://localhost:8888/Apps/SampleData/Vehicle.czml')
